...
import customer.model.ContactDetails;
import customer.model.Customer;
import customer.model.Note;
...
public class DataPrefill implements ApplicationListener<ApplicationReadyEvent> {
    ...
    private Customer newCustomer() {
        ...
        customer.setNotes(asList(newDescription("Interesting!"), newDescription("Some more text!")));
        return customer;
    }

    private Note newDescription(String s) {
        Note note = new Note();
